...
# Read current FinanceTracker.py from correct location
with open(r"d:\Python\Streamlit\FinanceTracker\FinanceTracker.py", "r") as f:
    lines = f.readlines()
...
# Write back
with open(r"d:\Python\Streamlit\FinanceTracker\FinanceTracker.py", "w") as f:
